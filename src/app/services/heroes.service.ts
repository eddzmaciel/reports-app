...
//decorator for my service class
@Injectable()
export class HeroesService {
  //creating hero object as a Heroe type
  private heroes: HeroeFormat[] = [
    {
      nombre: "Aquaman",
      bio:
  ...
  //we use  getHeores():HeroeFormat[]  to specify that is returning heroe as a HeroeFormat Array
  getHeores(): HeroeFormat[] {
    return this.heroes;
  }

  getHeroeDetail(idx: string) {
    return this.heroes[idx];
  }

  buscarHeroes(termino: string) {
    let heroesArr: HeroeFormat[] = [];
